...
function Social() {
  return (
    <div className="flex items-center justify-center gap-2 px-2">
      ...
      <div>
        <a href='https://www.instagram.com/adh_automotive/' aria-label='ADH Automotive Instgram Page'>
         <svg className='h-6 fill-green-700 hover:opacity-50 active:fill-green-600 active:opacity-100 hidden' viewBox="0 0 24 24">
          <path
            fillRule="evenodd"
